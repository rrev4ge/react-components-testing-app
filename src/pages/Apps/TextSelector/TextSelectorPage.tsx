...
const TextSelector = () => {
  ...
  const [paragraph, setParagraph] = useState<string>(defaultParagraphList[0].content);

  const [sortQuoteList, setSortQuoteList] = useState<IQuote[]>(defaultParagraphList[0].quotes || []);
